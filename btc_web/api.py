...
Routes:
    ...
    GET  /api/cache-stats         — L0/L1/L2 cache stats (JSON)
    GET  /docs/architecture       — architecture guide (HTML)
    GET  /docs/user-manual        — user manual (HTML)
    GET  /assets/.deferred/<f>    — deferred JS chunks
...
import btcpay
from colors import (
    STATIC_PAGE_BG, STATIC_PAGE_ACCENT, STATIC_PAGE_SUBHEAD,
    STATIC_PAGE_CODE_BG, STATIC_PAGE_TH_BG,
