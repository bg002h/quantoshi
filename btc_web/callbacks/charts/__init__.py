...
@callback(
    ...
    Input("bub-model-show", "value"),
    # bub-bubble-toggles + bub-n-future: demoted Input→State; commit
    # via bm-commit-trigger when the BM config modal closes.
    State("bub-bubble-toggles", "value"),
    State("bub-n-future", "value"),
    Input("bm-commit-trigger", "data"),
    Input("bub-legend-pos", "value"),
...
@callback(
    ...
    Input("hm-line-width","value"),
    Input("hm-line-color","value"),
...
def update_heatmap(_first_render, hm_model, entry_yr, entry_q, exit_range, exit_qs, mode,
                   ...
                   vfmt, cell_fs, line_width, line_color, toggles, stack, use_lots, lots_data,
    ...
    _POST_RESTORE_TRIGGERS_HM = {
        ...
        "hm-c-hi", "hm-grad", "hm-vfmt", "hm-cell-fs",
        "hm-line-width", "hm-line-color",
        "hm-toggles", "hm-stack", "hm-use-lots",
    ...
    shared_params = dict(
        ...
        line_width   = _cf(line_width, HEATMAP["line_width"]),
        line_color   = line_color or HEATMAP["line_color"],
