...
from colors import CODE_BG, DANGER_HIGHLIGHT, _hex_alpha, UI_FONT_MD, UI_FONT_LG, FAQ_DANGER_BG_ALPHA
            ...
            html.Table([
                ...
                html.Tbody([
                    ...
                    html.Tr([html.Td(html.Strong("2013\u20132015")),
                            ...
                            style={"background": _hex_alpha(DANGER_HIGHLIGHT, FAQ_DANGER_BG_ALPHA)}),
...
def _faq_tab():
    ...
    # direct links (/10.N) since they reference items by position.
