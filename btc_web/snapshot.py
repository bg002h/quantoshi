...
_CHECKLIST_OPTIONS = {
    ...
    "bub-auto-y":         ["yes"],
    "dca-model-show":     ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_ex", "hybppl_ex_dd"],
    "ret-model-show":     ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_ex", "hybppl_ex_dd"],
    "sc-model-show":      ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_ex", "hybppl_ex_dd"],
    "hm-model-show":      ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_ex", "hybppl_ex_dd"],
    "bub-model-show":     ["pl", "lppl", "exp", "s2f", "ef", "bub", "qr", "hybppl_ex", "hybppl_ex_dd"],
