...
_CHECKLIST_OPTIONS = {
    ...
    "bub-auto-y":         ["yes"],
    "dca-model-show":     ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_dd", "gomp", "bpl"],
    "ret-model-show":     ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_dd", "gomp", "bpl"],
    "sc-model-show":      ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_dd", "gomp", "bpl"],
    "hm-model-show":      ["qr", "mc", "pl", "lppl", "exp", "s2f", "ef", "hybppl_dd", "gomp", "bpl"],
    "bub-model-show":     ["pl", "lppl", "exp", "s2f", "ef", "bub", "qr", "hybppl_dd", "gomp", "bpl"],
