...
- [feedback_no_auto_deploy.md](feedback_no_auto_deploy.md) — Show proposed images for approval before committing/deploying
- [reference_change_genesis.md](reference_change_genesis.md) — Procedure for changing the optimal time origin date across the entire codebase
- [project_remove_ogpl.md](project_remove_ogpl.md) — Remove OptGenesisPL model (redundant now that genesis = optimal date)
- [project_model_info_tab.md](project_model_info_tab.md) — Tab 7 is Model Info, FAQ bumped to tab 8
