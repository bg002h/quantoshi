...
def run_model_build() -> None:
    ...
    # All PPL models, Gompertz, BPL, config models, and PCA refit MONTHLY
    # via the quantoshi-ppl-refit.service systemd timer (1st of each month).
    # See tools/refit_all_ppl.py for the comprehensive monthly script.
    print("\n(PPL/EPPL/config model refitting skipped \u2014 runs monthly via systemd timer)")
